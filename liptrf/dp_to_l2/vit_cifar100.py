...
def main():
    ...
    l2_model =  ViT(patch_size=16, embed_dim=192, depth=12, num_heads=3, lmbda=1, num_classes=100)
    dp_model = timm.create_model('vit_tiny_patch16_224', pretrained=False, num_classes=100)
    args.layers = 12
