...
def main_worker(gpu, ngpus_per_node, args):
    ...
    # create model
    print ("Create Model")
    model =  ViT(patch_size=16, embed_dim=192, depth=12, num_heads=3, lmbda=1)
    weight = timm.create_model('vit_tiny_patch16_224', pretrained=True).state_dict()
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if not args.multiprocessing_distributed or (args.multiprocessing_distributed
            ...
            }, is_best, f"./weights/vit_tiny_patch16_224_imagenet1k_L2_adapted_checkpoint.pt")
