...
python -m torch.distributed.launch --nproc_per_node=4 train_tiny_multi.py --warmup 0 --model tiny_clmaxmin --batch_size 32 --rampup 125 --sniter 3 --epochs 250 --sparse 0.01 --indices 0,6,12,14,17 --data tinyimagenet --test_batch_size 32 --epsilon_train 0.16 --lr 1e-4 --lr_scheduler exp --prefix 'maxmin/tiny_8C2F_maxmin'
